...
@Component({
  ...
  `,
  styles: [`
    .error-page { min-height: 100vh; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); padding: 2rem; }
    ...
    h1 { font-size: 5rem; font-weight: 800; color: #e41e3f; margin: 0; line-height: 1; }
