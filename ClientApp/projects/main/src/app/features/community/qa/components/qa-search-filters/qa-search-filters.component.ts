...
@Component({
  ...
  template: `
    ...
    <div class="fluent-card p-6 mb-8" [class.expanded]="showAdvancedFilters()">
        ...
        <div class="flex-1">
          <div class="relative">
            ...
            <input type="text" 
                   ...
                   class="fluent-input pl-12 pr-4 py-4 text-lg">
            <div *ngIf="searchTerm()" 
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="flex bg-gray-100 dark:bg-gray-800 rounded-xl p-1.5 shadow-inner">
            <button *ngFor="let sort of sortOptions(); trackBy: trackBySortValue"
                    ...
                    [style.color]="sortBy() === sort.value ? 'var(--color-primary)' : ''"
                    [class.shadow-sm]="sortBy() === sort.value"
                    class="px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center gap-2">
          ...
          <div class="flex items-center bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
            <button (click)="setViewMode('card')"
                    ...
                    [style.color]="viewMode() === 'card' ? 'var(--color-primary)' : ''"
            ...
            <button (click)="setViewMode('compact')"
                    ...
                    [style.color]="viewMode() === 'compact' ? 'var(--color-primary)' : ''"
      ...
      <div *ngIf="showAdvancedFilters()" class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700 animate-fade-in">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <select [(ngModel)]="selectedStatus" (change)="filtersChanged.emit()" class="fluent-input">
          ...
          <div>
            ...
            <select [(ngModel)]="selectedCategory" (change)="filtersChanged.emit()" class="fluent-input">
          ...
          <div>
            ...
            <select [(ngModel)]="dateFilter" (change)="filtersChanged.emit()" class="fluent-input">
          ...
          <div>
            ...
            <select [(ngModel)]="bountyFilter" (change)="filtersChanged.emit()" class="fluent-input">
              <option value="">All Questions</option>
        ...
        <div class="mt-6">
          ...
          <div class="flex flex-wrap gap-2">
            <button *ngFor="let tag of popularTags(); trackBy: trackByTag"
                    ...
                    [style.background-color]="selectedTag() === tag ? 'var(--color-primary-100)' : ''"
                    [style.color]="selectedTag() === tag ? 'var(--color-primary)' : ''"
                    [style.border]="selectedTag() === tag ? '2px solid var(--color-primary)' : ''"
                    class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 transition-all duration-200 cursor-pointer">
              #{{ tag }}
...
export class QASearchFiltersComponent {
  ...
  getTagCount(tag: string): number {
    // This would come from a service or input
