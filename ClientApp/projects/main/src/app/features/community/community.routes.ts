...
export const communityRoutes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'qa/tags', loadComponent: () => import('./qa/tags-list/tags-list.component').then(m => m.TagsListComponent) },
      { path: 'qa/tag/:tag', loadComponent: () => import('./qa/tag-detail/tag-detail.component').then(m => m.TagDetailComponent) },
