...
@Component({
  ...
  template: `
    <nav [class]="sidebarClasses()" aria-label="Main navigation">
      <div class="p-4 space-y-6">
        <!-- Main Section -->
        <div>
          <div class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3 px-3">Main</div>
          <ul class="space-y-1">
            <li>
              <a routerLink="dashboard" routerLinkActive="active"
                 class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors duration-150 group"
                ...
                <svg class="w-5 h-5" [class.text-white]="isLinkActive('dashboard')" [class.text-gray-500]="!isLinkActive('dashboard')" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Management Section -->
        <div>
          <div class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3 px-3">Management</div>
          <ul class="space-y-1">
            <li>
              <a routerLink="users" routerLinkActive="active"
                ...
                <svg class="w-5 h-5" [class.text-white]="isLinkActive('users')" [class.text-gray-500]="!isLinkActive('users')" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <a routerLink="content" routerLinkActive="active"
                ...
                <svg class="w-5 h-5" [class.text-white]="isLinkActive('content')" [class.text-gray-500]="!isLinkActive('content')" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <a routerLink="moderation" routerLinkActive="active"
                ...
                <svg class="w-5 h-5" [class.text-white]="isLinkActive('moderation')" [class.text-gray-500]="!isLinkActive('moderation')" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Analytics Section -->
        <div>
          <div class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3 px-3">Analytics</div>
          <ul class="space-y-1">
            <li>
              <a routerLink="reports" routerLinkActive="active"
                ...
                <svg class="w-5 h-5" [class.text-white]="isLinkActive('reports')" [class.text-gray-500]="!isLinkActive('reports')" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                </svg>
        ...
        <div>
          <div class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3 px-3">Configuration</div>
          <ul class="space-y-1">
            <li>
              <a routerLink="settings" routerLinkActive="active"
                ...
                <svg class="w-5 h-5" [class.text-white]="isLinkActive('settings')" [class.text-gray-500]="!isLinkActive('settings')" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Account Section -->
        <div>
          <div class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3 px-3">Account</div>
          <ul class="space-y-1">
            <li>
              <a routerLink="profile" routerLinkActive="active"
                ...
                <svg class="w-5 h-5" [class.text-white]="isLinkActive('profile')" [class.text-gray-500]="!isLinkActive('profile')" fill="none" stroke="currentColor" viewBox="0 0 24 24">
